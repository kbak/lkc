...
public class WindowWelcome {
	...
	WindowWelcome(final String gladeFile) throws FileNotFoundException {
		...
		final RadioButton rbtnStartNew = (RadioButton) xmlWndWelcome
				.getWidget("rbtnStartNew");
		final FileChooserDialog fcdChooseFile = (FileChooserDialog) xmlChooseFile
				.getWidget("fcdChooseFile");
